...
class SecurityMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request, resp):
        ...
        h = {
            'default-src': ["{static}"],
            'script-src': ["{static}", "unsafe-inline", "https://app.sandbox.midtrans.com"],
            'object-src': ["'none'"],
            'frame-src': ["{static}", "self", "https://app.sandbox.midtrans.com"],
            'style-src': ["{static}", "{media}"],
            'connect-src': ["{dynamic}", "{media}", "self", "https://app.sandbox.midtrans.com"],
            'img-src': ["{static}", "{media}", "self", "https://app.sandbox.midtrans.com", "data:"] + img_src,
